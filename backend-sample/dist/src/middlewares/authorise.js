...
var authorise = function (permission) {
    var roles = [];
    ...
    return function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var id, user, err, result, err, err;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.userId;
                        return [4 /*yield*/, (0, userService_1.getUserById)(id)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
                            err = new Error("This account has not registered!.");
                            err.status = 401;
                        ...
                        if (!permission && result) {
                            err = new Error("This action is not allowed.");
                            err.status = 403;
